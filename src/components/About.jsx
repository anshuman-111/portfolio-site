...
const About = () => {
  return (
    <div name="About" className='bg-gradient-to-b p-4 to-black from-slate-600 w-full h-screen'>
        <div className='sm:my-16 mt-32 max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
        <div className='mb-4'>
        <h2 className='text-4xl font-bold border-b-4 border-gray-500 p-2 inline text-white'>About</h2>
        </div>
        <div className='mt-5'>
        <p className='text-lg md:text-xl text-white mb-3 text-justify p-5'>
        ...
        <p className='text-lg md:text-xl text-white mt-3 text-justify p-5'>
